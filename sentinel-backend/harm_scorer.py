    ...
    def __init__(self, 
        ...
        if os.path.exists(sentiment_model_path):
            ...
            try:
                ...
                print(f"✅ Sentiment model loaded: {list(self.id_to_sentiment.values())}")
        ...
        if os.path.exists(stance_model_path):
            ...
            try:
                self.stance_tokenizer = AutoTokenizer.from_pretrained(stance_model_path)
                ...
                label_file = os.path.join(stance_model_path, 'label_mappings.json')
                ...
                print(f"✅ Stance model loaded: {list(self.id_to_stance.values())}")
            except Exception as e:
